...
var author$project$Main$init = {benefitsPct: '0.2', bonusPct: '0.01', holidaysAmt: '10', netAmt: '0', nonBillablePct: '0.2', sickdaysAmt: '7'};
		...
		switch (msg.$) {
			...
			case 'Bonus':
				...
				return _Utils_update(
					...
					{bonusPct: bonusPct});
			case 'Sickdays':
				var sickdaysAmt = msg.a;
				return _Utils_update(
					model,
					{sickdaysAmt: sickdaysAmt});
			case 'Benefits':
				var benefitsPct = msg.a;
				return _Utils_update(
					model,
					{benefitsPct: benefitsPct});
			case 'Holidays':
				var holidaysAmt = msg.a;
				return _Utils_update(
					model,
					{holidaysAmt: holidaysAmt});
			default:
				var nonBillablePct = msg.a;
				return _Utils_update(
					model,
					{nonBillablePct: nonBillablePct});
		}
	});
var author$project$Main$Benefits = function (a) {
	return {$: 'Benefits', a: a};
};
var author$project$Main$Bonus = function (a) {
	return {$: 'Bonus', a: a};
};
var author$project$Main$Holidays = function (a) {
	return {$: 'Holidays', a: a};
};
var author$project$Main$Net = function (a) {
	return {$: 'Net', a: a};
};
var author$project$Main$Nonbillable = function (a) {
	return {$: 'Nonbillable', a: a};
};
var author$project$Main$Sickdays = function (a) {
	return {$: 'Sickdays', a: a};
};
...
var author$project$Main$viewInput = F5(
	function (l, t, p, v, toMsg) {
		return A2(
			elm$html$Html$label,
			_List_fromArray(
				[
					elm$html$Html$Attributes$for(l)
				]),
			_List_fromArray(
				[
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A5(author$project$Main$viewInput, 'net', 'text', 'Net', model.netAmt, author$project$Main$Net),
				A5(author$project$Main$viewInput, 'bonus', 'text', 'Bonus', model.bonusPct, author$project$Main$Bonus),
				A5(author$project$Main$viewInput, 'sickdays', 'text', 'Sickdays', model.sickdaysAmt, author$project$Main$Sickdays),
				A5(author$project$Main$viewInput, 'benefits', 'text', 'Benefits', model.benefitsPct, author$project$Main$Benefits),
				A5(author$project$Main$viewInput, 'holidays', 'text', 'Holidays', model.holidaysAmt, author$project$Main$Holidays),
				A5(author$project$Main$viewInput, 'non billable time', 'text', 'nonBillablePct', model.nonBillablePct, author$project$Main$Nonbillable)
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"Net":["String.String"],"Bonus":["String.String"],"Sickdays":["String.String"],"Benefits":["String.String"],"Holidays":["String.String"],"Nonbillable":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
